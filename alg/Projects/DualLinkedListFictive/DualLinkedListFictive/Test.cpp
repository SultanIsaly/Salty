#include <string>
#include <iostream>
#include "DualLinkedListFictive.h"
...
{
	CDoublyLinkedListFictive<MyStruct> list;
	for (int i = 0; i < n; ++i)
	{
	...
	CDoublyLinkedListFictive<MyStruct>::CIterator it = list.begin();
...
void testEraseNextAndPostEnd()
{
	...
	CDoublyLinkedListFictive<MyStruct>::CIterator it = list.end();
	--it;
